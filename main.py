...
from handlers.debts.addDebtByText import addDebtByText
from modules.userActions import verifyIfUserAlreadyAdd, createNewUser, addUserEmail
from handlers.debts import debts, debtsList
...
def unknown_text(update, context):
    isAddDebtMode = addDebtByText(update, context)
    if (isAddDebtMode): 
        return 
...
updater.dispatcher.add_handler(CommandHandler('dsl', debtsList))
